      ...
      <main className="flex-1">
        ...
        >
          <div className="container px-4 md:px-6 max-w-3xl space-y-6 z-10">
            ...
            <div
              className="space-x-4 pt-4 animate-scale-in"
          ...
          <div className="container px-4 md:px-6 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  As a dedicated Node.js developer, I specialize in building
                  efficient and high-performing backend systems. My expertise
                  spans across various frameworks, including React, Next.js for
                  frontend, and Express, Nest.js for robust backend solutions. I
                  thrive on solving complex problems and delivering clean,
                  maintainable code.
                </p>
                <p>
                  I am constantly exploring new technologies and best practices
                  to stay at the forefront of web development. My goal is to
                  create seamless digital experiences that are both powerful and
                  intuitive.
                </p>
              </div>
            </div>
