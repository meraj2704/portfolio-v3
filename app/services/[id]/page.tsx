      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container px-4 md:px-6 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            {IconComponent && <IconComponent className="h-16 w-16 text-accent-primary mx-auto mb-6" />}
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            ...
            <p>
              If you're interested in this service or have a specific project in mind, feel free to <Link href="/#contact" className="text-accent-primary hover:underline">contact me</Link> to discuss your needs.
            </p>
          </div>
        </div>
      </main>
